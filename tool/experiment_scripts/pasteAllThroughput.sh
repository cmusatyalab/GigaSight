...
outputFile=${fileBase}_throughput_joined.txt
$(cat ${fileBase}_0_throughput.txt | cut -f1 > dump00.txt)
$(cat ${fileBase}_0_throughput.txt | cut -f2 > dump01.txt)
$(cat ${fileBase}_1_throughput.txt | cut -f1 > dump10.txt)
$(cat ${fileBase}_1_throughput.txt | cut -f2 > dump11.txt)
$(cat ${fileBase}_2_throughput.txt | cut -f1 > dump20.txt)
$(cat ${fileBase}_2_throughput.txt | cut -f2 > dump21.txt)
$(cat ${fileBase}_3_throughput.txt | cut -f1 > dump30.txt)
$(cat ${fileBase}_3_throughput.txt | cut -f2 > dump31.txt)
$(cat ${fileBase}_4_throughput.txt | cut -f1 > dump40.txt)
$(cat ${fileBase}_4_throughput.txt | cut -f2 > dump41.txt)
